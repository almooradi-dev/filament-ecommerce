...
{
	// Credits: https://darkghosthunter.medium.com/laravel-packages-load-or-publish-migrations-119db770c870
	...
	// php artisan vendor:publish --provider="Almooradi\FilamentEcommerce\FilamentEcommerceServiceProvider" --tag="migrations"
}
